...
def get_alert_text(driver):
    ...
    alert.accept()
    return text    
def test_empty_username(setup_teardown: WebDriver):
...
def test_empty_password(setup_teardown: WebDriver):
    driver=setup_teardown
    driver.get("http:/127.0.0.1:5000")
...
def test_short_pwd(setup_teardown: WebDriver):
    driver=setup_teardown
    driver.get("http:/127.0.0.1:5000")
    driver.find_element(By.NAME,"username").send_keys("Kaveri")
...
def test_valid_input(setup_teardown: WebDriver):
    driver=setup_teardown
    driver.get("http:/127.0.0.1:5000")
    driver.find_element(By.NAME,"username").send_keys("Kaveri")
    driver.find_element(By.NAME,"password").send_keys("Kaveri@1729")
